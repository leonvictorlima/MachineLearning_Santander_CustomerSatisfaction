...
** In the case of the `Principal_Santander_CustomerSatisfaction.ipynb` notebook file does not open. Please, copy this link (https://github.com/leonvictorlima/MachineLearning_Santander_CustomerSatisfaction/blob/main/Principal_Santander_CustomerSatisfaction.ipynb) and paste it on https://nbviewer.jupyter.org/ to get access for it content.
