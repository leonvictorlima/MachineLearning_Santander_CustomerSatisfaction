...
# Saving data set
df4.to_csv('df4.csv', index_column = False)

# For now, this is the end of exporatory analysis. Futhermore, machine learning models are applied in following files:

#[1] Santander_CustomerSatisfaction_ML_Attempt01_SMOTE_StandardScaler_GaussianNB.py
#[2] Santander_CustomerSatisfaction_ML_Attempt02_SMOTE_StandardScaler_LogisticRegression.py
#[3] Santander_CustomerSatisfaction_ML_Attempt03_StandardScaler_CrossValidation_GaussianNB.py
#[4] Santander_CustomerSatisfaction_ML_Attempt04_SMOTE_StandardScaler_CrossValidation_GaussianNB.py
#[5] Santander_CustomerSatisfaction_ML_Attempt05_StandardScaler_CrossValidation_LogisticRegression.py
#[6] Santander_CustomerSatisfaction_ML_Attempt06_SMOTE_StandardScaler_CrossValidation_LogisticRegression.py
#[7] Santander_CustomerSatisfaction_ML_Attempt07_SMOTE_StandardScaler_CrossValidation_LogisticRegression_AnotherWay.py
#[8] Santander_CustomerSatisfaction_ML_Attempt08_SMOTE_MaxMinScaler_PCA_CrossValidation_MachineLearningModels.py
#[9] Santander_CustomerSatisfaction_ML_Attempt09_StandardScaler_CrossValidation_MachineLearningModels.py
#[10] Santander_CustomerSatisfaction_ML_Attempt10_MaxMinScaler_PCA_CrossValidation_MachineLearningModels.py


# The model which got the best score and will be implemented to this analysis is the number 08 (eight). After any modelations and
# techniques implemented, this one had the best results and is the choosen to our business problem.

# In order to interprete results, please be free to get into this files and explory it.